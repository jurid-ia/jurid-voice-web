            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <div className="group flex h-10 cursor-pointer items-center gap-2 rounded-full bg-white/10 px-1 pr-3 text-white transition-all duration-200 hover:bg-white/20">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-primary to-black text-sm font-semibold text-white shadow-inner">
              ...
              >
                {/* User Info Header */}
                <div className="bg-gradient-to-br from-primary via-primary to-black p-4">
                ...
                <div className="p-2">
                  ...
                  >
                    <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-primary text-white transition-colors group-hover:bg-primary group-hover:text-white">
                  ...
                  >
                    <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-primary text-white transition-colors group-hover:bg-green-500 group-hover:text-white">
                  ...
                  >
                    <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-primary text-white transition-colors group-hover:bg-emerald-500 group-hover:text-white">
