...
export const inputVariants = cva(
  " w-full   bg-white/40  border-primary   px-3 h-9     file:border-0 file:bg-transparent  file:font-medium  read-only:leading-9 read-only:bg-background  disabled:cursor-auto disabled:opacity-80  transition duration-300 ",
  {
    variants: {
      color: {
        default:
