...
export const textareaVariants = cva(
  "flex flex-1 bg-white/40 text-secondary w-full min-h-[80px]   px-3 py-[10px]   file:border-0 file:bg-transparent file:font-medium  read-only:bg-background  disabled:cursor-auto disabled:opacity-80  transition duration-300 ",
  {
    variants: {
      color: {
        default:
          "border-neutral-300 text-white focus:outline-none focus:border-primary disabled:bg-default-200  placeholder:text-neutral-300 text-black",
        primary:
