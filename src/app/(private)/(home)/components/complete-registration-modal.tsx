    ...
    return (
        <div className="fixed inset-0 z-[99999] flex items-center justify-center bg-black/70 backdrop-blur-[6px] p-4 animate-in fade-in duration-300">
            <div className="relative w-full max-w-5xl overflow-hidden rounded-3xl bg-white shadow-2xl flex flex-col md:flex-row min-h-[600px] animate-in zoom-in-95 slide-in-from-bottom-5 duration-500">
                ...
                <div className="relative hidden w-1/2 md:block overflow-hidden bg-stone-950">
                    ...
                    <div className="absolute top-10 left-10 z-20">
                        <div className="flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 backdrop-blur-md border border-white/20">
                            <div className="h-2 w-2 rounded-full bg-stone-700 animate-pulse shadow-[0_0_8px_rgba(180,83,9,0.8)]" />
                    ...
                    <div className="absolute bottom-10 left-10 z-20 text-white max-w-md pr-8">
                        ...
                        <p className="mt-4 text-base text-stone-100 opacity-90 leading-relaxed font-light">
                        ...
                        {images.map((_, i) => (
                            <div
                                ...
                                className={cn(
                                    ...
                                    i === currentImageIndex ? "w-8 bg-stone-700" : "w-2 bg-white/30"
                                )}
                            />
                        ))}
                    </div>
                            ...
                            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                                ...
                                <div className="pt-6">
                                    ...
                                    <p className="mt-6 text-center text-xs text-slate-400 font-medium">
                                        Ao continuar, você aceita nossos <span className="text-stone-900 cursor-pointer hover:underline font-semibold">Termos de Uso</span> e <span className="text-stone-900 cursor-pointer hover:underline font-semibold">Política de Privacidade</span>.
                                    </p>
                                </div>
                            </form>
                        </Form>
