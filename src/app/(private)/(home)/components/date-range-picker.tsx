          ...
          <div className="flex min-w-[140px] flex-col border-r border-gray-100 bg-gray-50/80 p-3">
            ...
            {quickSelects.map((option) => (
              <button
                ...
                className="rounded-xl px-3 py-2.5 text-left text-sm font-medium text-gray-600 transition-all hover:bg-white hover:text-primary hover:shadow-sm"
              >
                {option.label}
              </button>
            ))}
          ...
          <div className="p-4">
            <DayPicker
              ...
              classNames={{
                ...
                cell: "text-center text-sm p-0 relative [&:has([aria-selected])]:bg-primary/10 first:[&:has([aria-selected])]:rounded-l-lg last:[&:has([aria-selected])]:rounded-r-lg focus-within:relative focus-within:z-20",
                ...
                day_selected:
                  "bg-gradient-to-br from-primary to-primary text-white shadow-md shadow-primary/20 hover:from-primary  hover:to-white hover:shadow-lg hover:shadow-primary/30",
                day_today:
