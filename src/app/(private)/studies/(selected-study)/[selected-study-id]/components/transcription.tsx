              ...
              <div className="px-8 pb-12 pt-8">
                <div className="mx-auto max-w-4xl">
                  ...
                  <div className="mb-8 flex items-center justify-between border-b border-slate-100 pb-6">
                    ...
                    <button
                      onClick={handleCopy}
                      className="group flex items-center gap-2 rounded-xl bg-slate-50 px-4 py-2.5 text-sm font-bold text-slate-600 transition-all hover:bg-primary hover:text-white"
                    >
                      {copied ? (
