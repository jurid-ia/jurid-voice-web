...
import { Bell, Check, Clock, Type, X } from "lucide-react";
                ...
                <form onSubmit={handleSave} className="flex flex-col gap-5">
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            className="w-full rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 text-lg font-medium text-gray-900 focus:border-primary focus:bg-white focus:outline-none focus:ring-4 focus:ring-primary/10 transition-all"
                            required
                        />
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            ...
                            rows={3}
                            className="w-full resize-none rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-900 focus:border-primary focus:bg-white focus:outline-none focus:ring-4 focus:ring-primary/10 transition-all"
                    ...
                    <div className="mt-2 flex gap-3">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="flex-1 rounded-2xl bg-gradient-to-r from-primary to-primary py-3.5 text-sm font-bold text-white shadow-lg shadow-primary/25 hover:shadow-primary/40 active:scale-95 disabled:opacity-50 transition-all flex items-center justify-center gap-2"
                        >
                            {loading ? (
