                    ...
                    <TableRow>
                      ...
                      >
                        <div className="flex items-start text-start">
                          <AudioRecorder buttonClassName="rounded-lg bg-gradient-to-r from-stone-600 to-stone-800 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-stone-700/25 transition-all hover:shadow-stone-700/40 active:scale-95 mx-auto" />
                        </div>
                      </TableCell>
                    </TableRow>
                  )}
