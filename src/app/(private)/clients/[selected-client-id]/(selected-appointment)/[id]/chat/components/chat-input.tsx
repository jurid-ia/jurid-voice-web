              ...
              return (
                <div key={fileKey} className="relative flex items-center pr-2">
                  <WaveformAudioPlayer
                    audioUrl={url}
                    barCount={20}
                    className="w-64 border border-blue-100 bg-white py-2 shadow-sm [&_button]:bg-blue-50 [&_button]:text-primary [&_button]:hover:bg-blue-100 [&_span]:text-primary [&_svg]:fill-primary [&_svg]:text-primary"
                    videoDuration="00:00"
                  />
                  <button
