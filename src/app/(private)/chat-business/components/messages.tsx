      ...
      return (
        ...
        >
          <WaveformAudioPlayer
            ...
            videoDuration="00:00"
            barCount={24}
            className="[ border border-stone-100 bg-white shadow-sm [&_button]:bg-stone-50 [&_button]:text-stone-900 [&_button]:hover:bg-stone-100 [&_span]:font-bold [&_span]:text-stone-900 [&_svg]:text-stone-900"
          />
        </div>
      );
    }
